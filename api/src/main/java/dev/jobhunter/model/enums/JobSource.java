...
public enum JobSource {
    ...
    // Aggregator sources
    LINKEDIN, INDEED, BERLIN_STARTUP_JOBS, ARBEITNOW, CAREERS_IN_GOTHENBURG, INSTAFFO,
    // Direct career pages
    DIRECT,
    // Fallback
    UNKNOWN;

    private static final List<JobSource> AGGREGATORS = List.of(LINKEDIN, INDEED, BERLIN_STARTUP_JOBS, ARBEITNOW, CAREERS_IN_GOTHENBURG, INSTAFFO);
