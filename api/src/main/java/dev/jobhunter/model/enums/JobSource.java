...
public enum JobSource {
    ...
    // Aggregator sources
    LINKEDIN, INDEED, BERLIN_STARTUP_JOBS, ARBEITNOW, CAREERS_IN_GOTHENBURG, INSTAFFO, BUILTIN_EUROPE, JOBGETHER, WORK_IN_FINLAND, GLOBAL_MOVE,
    // Direct career pages
    DIRECT,
    // Fallback
    UNKNOWN;

    private static final List<JobSource> AGGREGATORS = List.of(LINKEDIN, INDEED, BERLIN_STARTUP_JOBS, ARBEITNOW, CAREERS_IN_GOTHENBURG, INSTAFFO, BUILTIN_EUROPE, JOBGETHER, WORK_IN_FINLAND, STEPSTONE);
