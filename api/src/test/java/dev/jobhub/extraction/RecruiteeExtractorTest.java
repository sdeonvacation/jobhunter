...
@WireMockTest
class RecruiteeExtractorTest {

    private RecruiteeExtractor extractor;
    ...
    void setUp(WireMockRuntimeInfo wmInfo) {
        ...
        extractor = new RecruiteeExtractor(webClient, new ObjectMapper(), baseUrlTemplate);
    }

    @Test
    void supportedTypes_returnsRecruitee() {
        assertThat(extractor.supportedTypes()).containsExactly(AtsType.RECRUITEE);
    }
