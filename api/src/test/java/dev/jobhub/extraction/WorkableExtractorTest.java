...
@WireMockTest
class WorkableExtractorTest {

    private WorkableExtractor extractor;

    @BeforeEach
    void setUp(WireMockRuntimeInfo wmInfo) {
        WebClient webClient = WebClient.builder().build();
        extractor = new WorkableExtractor(webClient, new ObjectMapper(), wmInfo.getHttpBaseUrl());
    }

    @Test
    void supportedTypes_returnsWorkable() {
        assertThat(extractor.supportedTypes()).containsExactly(AtsType.WORKABLE);
    }

    @Test
    void canExtract_validSlug_returnsTrue() {
