...
@WireMockTest
class WorkdayExtractorTest {

    private WorkdayExtractor extractor;
    ...
    void setUp(WireMockRuntimeInfo wmInfo) {
        ...
        extractor = new WorkdayExtractor(webClient, new ObjectMapper(), baseUrl);
    }

    @Test
    void supportedTypes_returnsWorkday() {
        assertThat(extractor.supportedTypes()).containsExactly(AtsType.WORKDAY);
    }
    ...
    void canExtract_validEndpoint_returnsTrue() {
        var endpoint = CareerEndpoint.builder()
                ...
                .atsSlug("SAP")
                .atsShardId("1")
                .url("https://SAP.wd1.myworkdayjobs.com/en-US/SAPCareers")
                .build();
    ...
    @Test
    void canExtract_nullShardId_returnsFalse() {
        var endpoint = CareerEndpoint.builder()
                .atsType(AtsType.WORKDAY)
                .atsSlug("SAP")
                .atsShardId(null)
                .url("https://SAP.wd1.myworkdayjobs.com/Careers")
                .build();
        assertThat(extractor.canExtract(endpoint)).isFalse();
    }

    @Test
    void canExtract_blankShardId_returnsFalse() {
        var endpoint = CareerEndpoint.builder()
                .atsType(AtsType.WORKDAY)
                .atsSlug("SAP")
                .atsShardId("")
    ...
    void canExtract_wrongAtsType_returnsFalse() {
        var endpoint = CareerEndpoint.builder()
                ...
                .atsSlug("SAP")
                .atsShardId("1")
                .url("https://boards.greenhouse.io/sap")
                .build();
        assertThat(extractor.canExtract(endpoint)).isFalse();
    }
