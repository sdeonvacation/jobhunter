...
@WireMockTest
class LeverExtractorTest {

    private LeverExtractor extractor;
    ...
    void setUp(WireMockRuntimeInfo wmInfo) {
        WebClient webClient = WebClient.builder()
                ...
                .build();
        baseUrl = wmInfo.getHttpBaseUrl();
        extractor = new TestableLeverExtractor(webClient, new ObjectMapper(), baseUrl);
    }

    @Test
    void supportedTypes_returnsLeverAndLeverEu() {
        assertThat(extractor.supportedTypes()).containsExactlyInAnyOrder(AtsType.LEVER, AtsType.LEVER_EU);
    }

    @Test
    void canExtract_leverType_validSlug_returnsTrue() {
    ...
    @Test
    void canExtract_leverEuType_validSlug_returnsTrue() {
        var endpoint = CareerEndpoint.builder()
     ...
     */
    private static class TestableLeverExtractor extends LeverExtractor {
        private final String baseUrl;
        private final ObjectMapper objectMapper;

        TestableLeverExtractor(WebClient webClient, ObjectMapper objectMapper, String baseUrl) {
